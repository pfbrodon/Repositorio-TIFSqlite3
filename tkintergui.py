...
#ENTRY#############################################################################################
entrada2=Entry(ventana,font=("Arial",10),width=10, textvariable=codigoBusq)
entrada2.place(x=110,y=60)
entrada3=Entry(ventana,font=("Arial",10),width=12, textvariable=itemTabla)
entrada3.place(x=110,y=90)
entrada4=Entry(ventana,font=("Arial",10),width=50, textvariable=itemTabla)
entrada4.place(x=110,y=120)
entrada5=Entry(ventana,font=("Arial",10),width=8, textvariable=itemTabla)
entrada5.place(x=110,y=150)
entrada6=Entry(ventana,font=("Arial",10),width=8, textvariable=itemTabla)
entrada6.place(x=110,y=180)
entrada7=Entry(ventana,font=("Arial",10),width=8 ,textvariable=itemTabla)
...
#BOTONES#########################################################################################
btn1=Button(ventana, font=("Arial",9), fg="black",background="light blue" ,border= 3,  text='VALORIZAR', command=busquedaCodigo)
btn1.place(x=811,y=50)
#btn1.config(font=11)
btn2=Button(ventana, font=("Arial",9), fg="black",background="light blue" ,border= 3,  text='BUSCAR CODIGO', command=busquedaCodigo)
btn2.place(x=811,y=90)
btn3=Button(ventana, font=("Arial",9), fg="black",background="light blue",border= 3 ,text='BUSCAR DESCRIPCION', command=busquedaDescripcion)
btn3.place(x=790,y=130)
btn4=Button(ventana, font=("Arial",9), fg="black",border= 3,  text='CARGAR LISTA DE PRECIOS', command=mostarTabla)
btn4.place(x=780,y=170)
btn5=Button(ventana, font=("Arial",9),fg="black",border= 3, background="light yellow" ,text='MODIFICAR PRODUCTO', command=modificarProducto)
btn5.place(x=370,y=210)
btn6=Button(ventana, font=("Arial",9), fg="black",border= 3, background="light green" ,text='ALTA PRODUCTO', command=insertarProducto)
btn6.place(x=585,y=210)
btn7=Button(ventana, font=("Arial",9), fg="black",border= 3, background="red"  ,text='BAJA PRODUCTO', command=borrarProducto)
btn7.place(x=200,y=210)
btn8=Button(ventana, font=("Arial",9), fg="black",border= 3,  text='LIMPIAR ENTRADA', command=limpiarEntry)
btn8.place(x=820,y=210)
